...
namespace Battle
{
    ...
    public partial struct Fix64 : IEquatable<Fix64>, IComparable<Fix64>
    {
        ...
        public static readonly Fix64 PIOver180 = new Fix64(72);
        ...
        public static readonly Fix64 MaxValue = (Fix64)3.40282347E+38;
        public static readonly Fix64 RVO_EPSILON = (Fix64)0.001;
        public static readonly Fix64 RADICAL3 = (Fix64)1.732;
        ...
        public static Fix64 Square(Fix64 value)
        {
            return value * value;
        }
        ...
        public static Fix64 Min(int a, int b)
        {
            int value = a > b ? b : a;
            return (Fix64)value;
        }

        public static Fix64 Max(int a, int b)
        {
            int value = a > b ? a : b;
            return (Fix64)value;
        }
        ...
        public static Fix64 ACos(Fix64 F)
        {
            ...
            var sqrt = Sqrt(FF + Fix64.One);

            return Atan(-F / sqrt) + 2 * Atan(Fix64.One);
        }
    ...
    public struct FixVector3
    {
        ...
        public static FixVector3 None = new FixVector3(-10000, -10000, -10000);

        public FixVector3 RemoveZ()
        {
...
#if _CLIENTLOGIC_
        public static FixVector3 ToFixVector3(Vector3 v3, bool z0 = false)
        {
            return new FixVector3((Fix64)v3.x, (Fix64)v3.y, z0 ? Fix64.Zero : (Fix64)v3.z);
        }
#endif
        ...
        public static Fix64 DotNoZ(FixVector3 a, FixVector3 b)
        {
    ...
    public struct FixVector2
    {
        ...
        public static FixVector2 None = new FixVector2(-10000, -10000);
        ...
        {
            return new FixVector3(this.x, this.y, Fix64.Zero);
        }
        ...
        public static FixVector2 operator -(FixVector2 vector)
        {
            return new FixVector2(-vector.x, -vector.y);
        }
        ...
        public static FixVector2 AngleAxis(FixVector2 fixVector2, Fix64 rad)
        {
            var x = fixVector2.x;
            var y = fixVector2.y;

            return new FixVector2(x * Fix64.Cos(rad) - y * Fix64.Sin(rad), y * Fix64.Cos(rad) + x * Fix64.Sin(rad));
        }

        public static FixVector2 Max(FixVector2 a, FixVector2 b)
        {
            return new FixVector2(Fix64.Max(a.x, b.x), Fix64.Max(a.y, b.y));
        }

        public static Fix64 Det(FixVector2 a, FixVector2 b)
        {
        ...
        public static Fix64 distSqPointLineSegment(FixVector2 vector1, FixVector2 vector2, FixVector2 vector3)
        {
            Fix64 r = Dot(vector3 - vector1, vector2 - vector1) / SqrMagnitude(vector2 - vector1);

            if (r < 0.0f)
            {
                return SqrMagnitude(vector3 - vector1);
            }

            if (r > 1.0f)
            {
                return SqrMagnitude(vector3 - vector2);
            }

            return SqrMagnitude(vector3 - (vector1 + r * (vector2 - vector1)));
        }

        public static Fix64 LeftOf(FixVector2 a, FixVector2 b, FixVector2 c)
        {
            return Det(a - c, b - a);
        }
    }
